...
func TestMemoryInsert(t *testing.T) {
	...
	val := memory.NewMaybeRelocatableFelt(lambdaworks.From(5))
...
func TestMemoryInsertOverWriteSameValue(t *testing.T) {
	...
	val := memory.NewMaybeRelocatableFelt(lambdaworks.From(7))
...
func TestMemoryInsertOverWriteValue(t *testing.T) {
	...
	val2 := memory.NewMaybeRelocatableFelt(lambdaworks.From(8))
...
func TestMemorySegmentsLoadDataUnallocatedSegment(t *testing.T) {
	...
	data := []memory.MaybeRelocatable{*memory.NewMaybeRelocatableFelt(lambdaworks.From(5))}
...
func TestMemorySegmentsLoadDataTwoElements(t *testing.T) {
	...
	ptr := memory.NewRelocatable(0, 0)
	val := memory.NewMaybeRelocatableFelt(lambdaworks.From(5))
	val2 := memory.NewMaybeRelocatableFelt(lambdaworks.From(5))
