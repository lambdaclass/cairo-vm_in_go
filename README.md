...
Once we retrive the felt, we have the `encoded insruction`, we need to decode it to get the fields from its bits representation. Felt is not useful anymore so we will get its integer representation. 
